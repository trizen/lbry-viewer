package WWW::LbryViewer::Authentication;
...
WWW::LbryViewer::Authentication - OAuth login support.

=head1 SYNOPSIS

    use WWW::LbryViewer;
    my $hash_ref = WWW::LbryViewer->oauth_login($code);
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::LbryViewer::Authentication
...
1;    # End of WWW::LbryViewer::Authentication
