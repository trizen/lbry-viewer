...
WWW::LbryViewer::Utils - Various utils.

=head1 SYNOPSIS

    use WWW::LbryViewer::Utils;

    my $yv_utils = WWW::LbryViewer::Utils->new(%opts);
...
sub normalize_filename {
    ...
    $basename = substr($basename, 0, 128);    # make sure the filename is not too long
    return $basename;
}
