package WWW::LbryViewer::ParseXML;
...
WWW::LbryViewer::ParseXML - Convert XML to a HASH ref structure.
...
Usage:
    ...
    use WWW::LbryViewer::ParseXML;
    my $hash_ref = WWW::LbryViewer::ParseXML::xml2hash($xml_string);
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::LbryViewer::ParseXML
...
1;    # End of WWW::LbryViewer::ParseXML
