...
sub get_itags {
    scalar {
        ...
        'best' => [{value => 'b', format => 'mp4'}, {value => 'original', format => 'mp4'},],
        ...
        '360' => [{value => "360p",      format => 'mp4'},
                  {value => "hls-140-1", format => 'mp4'},
        ...
        '144' => [{value => "144p",      format => 'mp4'},
                  {value => "hls-140-0", format => 'mp4'},
