package WWW::LbryViewer::Activities;
...
WWW::LbryViewer::Activities - list of channel activity events that match the request criteria.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::LbryViewer::Activities
...
1;    # End of WWW::LbryViewer::Activities
